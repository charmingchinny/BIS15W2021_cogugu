...
R is an open source scripting language and R studio is the system that basically translates that script into images and actions. Github is a file storage site where code can be uploaded and managed. It is useful because it is an organized way to store and share different code. 
