...
```r
homerange <- readr::read_csv("~/Desktop/BIS15W2021_cogugu/lab4/data/Tamburelloetal_HomeRangeDatabase.csv")
```
...
## genus                      "character"
## species                    "character"
## primarymethod              "character"
## N                          "character"
## mean.mass.g                "numeric"  
## log10.mass                 "numeric"  
## alternative.mass.reference "character"
## mean.hra.m2                "numeric"  
## log10.hra                  "numeric"  
## hra.reference              "character"
## realm                      "character"
## thermoregulation           "character"
## locomotion                 "character"
## trophic.guild              "character"
## dimension                  "character"
## preymass                   "numeric"  
## log10.preymass             "numeric"  
## PPMR                       "numeric"  
## prey.size.reference        "character"
```
...
**8. Do herbivores or carnivores have, on average, a larger `mean.hra.m2`? Remove any NAs from the data.**  Herbivores have the larger mean.hra.m2 on average. 
...
##    <chr>                       <dbl>
##  1 western worm snake            700
##  2 eastern worm snake            253
##  3 racer                      151000
##  4 yellow bellied racer       114500
##  5 ringneck snake               6476
##  6 eastern indigo snake      1853000
##  7 great plains ratsnake      150600
##  8 western ratsnake            46000
##  9 hognose snake              516375
## 10 European whipsnake         110900
## # … with 31 more rows
```
...
```
The Namaqua dwarf adder is a venomous snake from the Viperidae family. Their species is native to a small region that is along the border of Namibia and South Africa. 

https://en.wikipedia.org/wiki/Bitis_schneideri 
